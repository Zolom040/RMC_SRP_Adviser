...
class EveRequester:
    ...
    # Ответ -  killmail_id, zkb [location, hash, fittedValue (isk), dropValue (isk), destroyedValue, totalvalue, points, npc, solo, awox, labels ]
    ...
    def get_Inshurances(self):
        url = f"https://esi.evetech.net/dev/insurance/prices/"
        retries_left = MAX_RETRIES
    ...
    def get_Aliance_Info(self, alliance_id):
        url = f"https://esi.evetech.net/dev/alliances/{alliance_id}/"
        retries_left = MAX_RETRIES
