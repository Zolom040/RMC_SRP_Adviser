...
class esi_ID_loader:
    def __init__(self):
        ...
        self.cta_fleetcoms = self._load_from_file('CTA_fleetcoms.txt')
        self.light_ships = self._load_from_file("Light_Ships.txt")
        self.t3_ships = self._load_from_file("t3_ships.txt")
